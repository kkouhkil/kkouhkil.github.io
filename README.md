...
## Work Experience
<ul>
    <li><p>Research Associate and Entrepreneurship Fellow <span style="float: right"> University of Edinburgh (2021 - 2025)</span></p></li>
</ul>    
...
## Activities
<ul>
    <li><p>IPAB (<em>Institute of Perception, Action and Behaviour</em>) - Student Representative <span style="float: right"> University of Edinburgh (2019 - 2021)</span></p></li>
    <li><p>SSLC (<em>Staff Student Liaison Committee</em>) - Student Representative <span style="float: right"> University of Edinburgh (2019 - 2021)</span></p></li>
    <li><p>Teaching Support Provider <span style="float: right"> University of Edinburgh (2017 - 2021)</span></p></li>
    <li><p>BARC (<em>Birmingham Autonomous Robotic Club</em>) - Robotic Software Engineer <span style="float: right"> Uniersity of Birmingham (2014 - 2015)</span></p></li>
</ul>   
...
<h2 style="text-align: center">Dual-arm Heavy Object Manipulation and Human-Robot Interaction (HRI)</h2>
<img src="/assets/img/dual_arm_box_manipulation.png" align="center" width="100%"/>

<h2 style="text-align: center">Dual-arm Light Object Manipulation and Human-Robot Cooperation (HRC)</h2>
...
<br> <a href="https://www.youtube.com/watch?v=IIIjyDKxCtc"> <b>Video</b></a> &emsp; &emsp;
...
<!--  -->
<tr>
    <td style = ""><img src="/assets/img/achieving_dexterous_bidirectional.png"/></td>
...
<!--  -->
<tr>
    <td style = ""><img src="/assets/img/projected_inverse_dynamics.png"/></td>
